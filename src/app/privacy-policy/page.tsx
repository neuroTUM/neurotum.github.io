  ...
  return (
    <div className={styles.container}>
      <section className={styles.section}>
        ...
        <h2 className={styles.subtitle}>Mode and place of processing the Data</h2>
        <p className={styles.textBlock}>
          This Website collects some Personal Data from its Users. This document can be printed for reference by using
          the print command in the settings of any browser.
        </p>
        <h2 className={styles.subtitle}>Owner and Data Controller</h2>
        <p className={styles.textBlock}>neuroTUM e.V.</p>
        <p className={styles.textBlock}>Professur für Neuroelektronik</p>
        <p className={styles.textBlock}>Technische Universität München</p>
        <p className={styles.textBlock}>Boltzmannstraße 11</p>
        <p className={styles.textBlock}>85748 Garching</p>
        <p className={styles.textBlock}>
          <b>Owner contact email:</b> team@neurotum.com
        </p>
        <h2 className={styles.subtitle}>Types of Data collected</h2>
        <p className={styles.textBlock}>
          Among the types of Personal Data that this Website collects, by itself or through third parties, there are:
          Cookies; Usage Data; first name; last name; company name; email address; Data communicated in order to use the
          Service.
        </p>
        <p className={styles.textBlock}>
          ...
          freely provided by the User, or, in case of Usage Data, collected automatically when using this Website.
        </p>
        <p className={styles.textBlock}>
        ...
        <p className={styles.textBlock}>
          Users who are uncertain about which Personal Data is mandatory are welcome to contact the Owner. Any use of
          Cookies - or of other tracking tools - by this Website or by the owners of third-party services used by this
          Website serves the purpose of providing the Service required by the User, in addition to any other purposes
        ...
        <h3 className={styles.subSubtitle}>Methods of processing</h3>
        <p className={styles.textBlock}>
        ...
        <p className={styles.textBlock}>
          ...
          Data may be accessible to certain types of persons in charge, involved with the operation of this Website
        ...
        <h3 className={styles.subSubtitle}>Legal basis of processing</h3>
        <p className={styles.textBlock}>
        ...
        <h3 className={styles.subSubtitle}>Place</h3>
        <p className={styles.textBlock}>
        ...
        <h2 className={styles.subtitle}>The purposes of processing</h2>
        <p className={styles.textBlock}>
          ...
          parties), detect any malicious or fraudulent activity, as well as the following: Analytics, Tag Management,
          displaying content from external platforms, Contacting the User and Heat mapping and session recording.
        </p>
        <p className={styles.textBlock}>
          For specific information about the Personal Data used for each purpose, the User may refer to the section
          “Detailed information on the processing of Personal Data”.
        </p>
        <h2 className={styles.subtitle}>Detailed information on the processing of Personal Data</h2>
        <p className={styles.textBlock}>
          Personal Data is collected for the following purposes and using the following services:
        </p>
        <h3 className={styles.subSubtitle}>Analytics</h3>
        <p className={styles.textBlock}>
        ...
        <p className={styles.textBlock}>Google Analytics (Google LLC)</p>
        <p className={styles.textBlock}>
          ...
          with other Google services. Google may use the Data collected to contextualize and personalize the ads of its
          own advertising network.
        </p>
        <p>Personal Data processed: Cookies; Usage Data.</p>
        <p className={styles.textBlock}>Place of processing: United States</p>
        <h3 className={styles.subSubtitle}>Contacting the User</h3>
        <p>Contact form (this Website)</p>
        <p className={styles.textBlock}>
        ...
        <p className={styles.textBlock}>Personal Data processed: company name; email address; first name; last name.</p>
        ...
        <p className={styles.textBlock}>
          ...
          nature concerning this Website. Your email address might also be added to this list as a result of signing up
          to this Website or after making a purchase.
        </p>
        <p className={styles.textBlock}>Personal Data processed: email address; first name.</p>
        <h2 className={styles.subtitle}>The rights of users</h2>
        <p className={styles.textBlock}>
          Users may exercise certain rights regarding their Data processed by the Owner. In particular, Users have the
        ...
        <h3 className={styles.subSubtitle}>Details about the right to object to processing</h3>
        <p className={styles.textBlock}>
          Where Personal Data is processed for a public interest, in the exercise of an official authority vested in the
          Owner or for the purposes of the legitimate interests pursued by the Owner, Users may object to such
        ...
        <h3 className={styles.subSubtitle}>How to exercise these rights</h3>
        <p className={styles.textBlock}>
          Any requests to exercise User rights can be directed to the Owner through the contact details provided in this
          document. These requests can be exercised free of charge and will be addressed by the Owner as early as
          possible and always within one month.
        </p>
        <h2 className={styles.subtitle}>Additional information about Data collection and processing</h2>
        <h3 className={styles.subSubtitle}>Legal action</h3>
        <p className={styles.textBlock}>
        ...
        <h3 className={styles.subSubtitle}>Additional information about User's Personal Data</h3>
        <p className={styles.textBlock}>
        ...
        <h3 className={styles.subSubtitle}>System logs and maintenance</h3>
        <p className={styles.textBlock}>
          For operation and maintenance purposes, this Website and any third-party services may collect files that
          record interaction with this Website (System logs) use other Personal Data (such as the IP Address) for this
          purpose.
        </p>
        <h3 className={styles.subSubtitle}>Information not contained in this policy</h3>
        <p className={styles.textBlock}>
        ...
        <h3 className={styles.subSubtitle}>How “Do Not Track” requests are handled</h3>
        <p className={styles.textBlock}>
          This Website does not support “Do Not Track” requests. To determine whether any of the third-party services it
          uses honor the “Do Not Track” requests, please read their privacy policies.
        </p>
        <h3 className={styles.subSubtitle}>Changes to this privacy policy</h3>
        <p className={styles.textBlock}>
          The Owner reserves the right to make changes to this privacy policy at any time by notifying its Users on this
          page and possibly within this Website and/or - as far as technically and legally feasible - sending a notice
        ...
        <h3 className={styles.subSubtitle}>Legal information</h3>
        <p className={styles.textBlock}>
        ...
        <p className={styles.textBlock}>
          <i>Latest update: October 30th, 2023</i>
        </p>
      </section>
    </div>
  );
