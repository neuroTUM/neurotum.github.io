    ...
    <div className={styles.container}>
      <section className={styles.section}>
        ...
        <p className={styles.textBlock}>
          Das Impressum dieser Seite gilt auch für die neuroTUM Accounts auf den Social-Media-Platformen Instagram und
          LinkedIn.
        </p>
        <p className={styles.textBlock}>neuroTUM e.V.</p>
        <p className={styles.textBlock}>Professur für Neuroeletronik</p>
        <p className={styles.textBlock}>Technische Universität München</p>
        <p className={styles.textBlock}>85748 Garching bei München</p>
        <h2 className={styles.subtitle}>Haftung für Inhalte</h2>
        <p className={styles.textBlock}>
          ...
          Vertragsverhältnis mit den Nutzern des Internetangebots kommt nicht zustande. Als Diensteanbieter sind wir
          gemäß § 7 Abs.1 TMG für eigene Inhalte auf diesen Seiten nach den allgemeinen Gesetzen verantwortlich. Nach §§
          ...
          Inhalte umgehend entfernen. Der Betreiber behält es sich ausdrücklich vor, einzelne Webseiten, Web-Dienste
          oder das gesamte Angebot ohne gesonderte Ankündigung zu verändern, zu ergänzen, zu löschen oder die
          Veröffentlichung zeitweise oder endgültig einzustellen."
        </p>
        <h2 className={styles.subtitle}>Haftung für Links</h2>
        <p className={styles.textBlock}>
